            ...
            ZStack {
                ...
                HStack (alignment: .top){
                    VStack (alignment: .leading){
                        ...
                        Text("Portas que rangem, água a correr, Lá no escuro, você pode tremer. Espreitando no vapor, um segredo se esconde, Onde o medo vem, qual é esse nome?")
